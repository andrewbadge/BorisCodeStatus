...
{
    private const string ExePath = @"C:\Users\Test User\AppData\Local\Programs\BorisCodeStatus\BorisCodeStatus.Hooks.exe";
    ...
    {
        ClaudeSettingsMerger.Merge(@"C:\Old\BorisCodeStatus.Hooks.exe", SettingsPath);
    ...
    public void BacksUpAnExistingFileOnce()
    {
        ...
        var backup = SettingsPath + ".boriscodestatus.bak";
