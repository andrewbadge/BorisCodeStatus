...
namespace BorisCodeStatus.Hooks;
...
/// (<c>BorisCodeStatus.Hooks.exe statusline</c>, <c>... notification</c>, and so on).
///
...
internal static class Program
{
    ...
    private static int Main(string[] args)
    {
        ...
        try
        {
            ...
            Console.Error.WriteLine($"BorisCodeStatus: unrecognised verb '{verb}'.");
            return 0;
        }
        catch (Exception ex)
        {
