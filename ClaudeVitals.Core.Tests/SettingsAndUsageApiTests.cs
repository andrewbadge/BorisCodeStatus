...
{
    private const string ExePath = @"C:\Users\Test User\AppData\Local\Programs\ClaudeVitals\ClaudeVitals.Hooks.exe";
    ...
    {
        ClaudeSettingsMerger.Merge(@"C:\Old\ClaudeVitals.Hooks.exe", SettingsPath);
    ...
    public void BacksUpAnExistingFileOnce()
    {
        ...
        var backup = SettingsPath + ".claudevitals.bak";
